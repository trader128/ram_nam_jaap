...
abstract final class DeityCatalog {
  ...
  static const List<DeityPack> all = [
    DeityPack(
      ...
      meaning: 'Chanting the holy name of Lord Rama brings peace and purity.',
    ...
    DeityPack(
      ...
      meaning: 'The divine name of Krishna awakens love and devotion.',
    ...
    DeityPack(
      ...
      meaning: 'I bow to Goddess Durga, the protector from all suffering.',
    ...
    DeityPack(
      ...
      meaning:
          'I bow to Lord Hanuman, the embodiment of strength and devotion.',
